#!/usr/bin/python3
"""Test module for test classes"""
import pep8
import inspect


class TestClassDocumentation():
    """Class definition for TestClassDocumentation"""
    ...
    def documentation(self):
        """Function that checks for test module documentation"""
    ...
    def pep8(self, files):
        """Function that checks for pep8 conformity on the files"""
